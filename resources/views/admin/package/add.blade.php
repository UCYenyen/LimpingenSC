        ...
        <div class="w-screen min-h-screen justify-center max-w-7xl flex flex-col items-center p-4 md:p-8 pt-[12vh] md:pt-[10vh]">
            <div class="w-full max-w-2xl">
                <div class="mb-6 md:mb-8">
                    <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 text-center">Add New Package
                    </h1>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-4 md:p-6 lg:p-8">
                    <form action="{{ route('admin.package.store') }}" method="POST">
                        ...
                        <div class="mb-4 md:mb-6">
                            ...
                            <div class="relative">
                                <span class="absolute left-3 md:left-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm md:text-base">Rp
                                </span>
