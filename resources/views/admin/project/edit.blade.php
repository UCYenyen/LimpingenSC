        ...
        <div class="w-screen min-h-screen justify-center max-w-7xl flex flex-col items-center p-4 md:p-8 pt-[12vh] md:pt-[10vh]">
            <div class="w-full max-w-2xl">
                <div class="mb-6 md:mb-8">
                    <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 text-center">Edit Project</h1>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-4 md:p-6 lg:p-8">
                    <form action="{{ route('admin.project.update', $project->id) }}" method="POST"
                        ...
                        <div class="mb-4 md:mb-6">
                            ...
                            <div class="mb-4">
                                <p class="text-xs md:text-sm text-gray-600 mb-2">Current Image:</p>
                                <div class="relative w-full sm:w-auto flex justify-start">
                                    <img src="{{ $project->image_url }}" alt="{{ $project->name }}"
                                        class="w-full sm:w-48 h-48 sm:h-48 object-cover rounded-lg shadow-md" id="currentImage">
                                    
                                    @if($project->image_public_id !== 'No_Image_Available_zt8dja')
                                        <button type="button" onclick="confirmDeleteImage()"
                                            class="absolute right-auto left-auto bg-red-600 hover:bg-red-700 text-white rounded-full p-2 shadow-lg transition-colors duration-200">
                            ...
                            <p class="mt-1 text-xs md:text-sm text-gray-500">Leave empty to keep current image</p>
                            @error('image')
