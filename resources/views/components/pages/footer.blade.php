<footer class="w-full flex flex-col justify-between items-center bg-primary text-white">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-center lg:items-start p-8 gap-8 w-[80%]">
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-center lg:items-start">
            ...
            <div class="flex text-lg flex-col gap-4 items-center lg:items-start">
                <h2 class="text-4xl fw-bold">Services</h2>
                <a href="/pricing" class="font-normal text-white mb-0 text-center lg:text-start">
                    Websites
                </a> 
                <a href="/pricing" class="font-normal text-white mb-0 text-center lg:text-start">
                    Mobile apps
