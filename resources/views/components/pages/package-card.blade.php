<a href="/request" class="relative flex p-4 justify-between flex-col items-center sm:items-start gap-4 bg-white shadow-lg rounded-lg transition-all max-w-md overflow-hidden group cursor-pointer">
    ...
    <p href="/request" class="relative z-10 font-bold text-sm text-blue-600 group-hover:text-white transition-colors duration-300">Request Now</p>
</a>