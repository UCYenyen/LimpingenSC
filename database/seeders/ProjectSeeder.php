...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647846/mysabda_sg2csk.svg',
            'image_public_id' => 'mysabda_sg2csk',
            'user_id' => 1
        ]);
        ...
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647846/harapandigital_ga03ru.png',
            'image_public_id' => 'harapandigital_ga03ru',
            'user_id' => 1
        ]);
        ...
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647846/C4OMI_n40zmd.png',
            'image_public_id' => 'C4OMI_n40zmd',
            'user_id' => 1
        ]);
        ...
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647847/konseling_vfmago.png',
            'image_public_id' => 'konseling_vfmago',
            'user_id' => 1
        ]);
        ...
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647846/ref21_nr78yc.png',
            'image_public_id' => 'ref21_nr78yc',
            'user_id' => 1
        ]);
        ...
        DB::table('projects')->insert([
            ...
            'image_url' => 'https://res.cloudinary.com/dc6failxg/image/upload/v1762647847/pondok-pujian_akfq7f.png',
            'image_public_id' => 'pondok-pujian_akfq7f',
            'user_id' => 1
        ]);
    }
}
